      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-slate-900 overflow-hidden shadow-2xl z-10">
        ...
        <div className="relative z-10 flex flex-col justify-center items-start p-16 w-full h-full">
          ...
          <p className="text-slate-300 text-lg font-medium max-w-md leading-relaxed border-l-4 border-orange-500 pl-4">
            Create an account to order the finest concrete products, track your deliveries, and manage your workspace.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8 md:p-12 relative z-10">
        ...
        <div className="w-full max-w-md bg-white/80 lg:bg-white/70 backdrop-blur-2xl p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-white/60">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-xs font-black text-slate-700 mb-1.5 uppercase tracking-wide">Account Type</label>
              <select 
                name="role" 
                value={formData.role} 
                onChange={handleChange} 
                className="w-full p-4 bg-white/60 border border-slate-200/60 rounded-xl focus:ring-2 focus:ring-orange-500 focus:bg-white outline-none transition-all font-bold text-slate-800 cursor-pointer"
              >
          ...
          <div className="mt-8 text-center">
            <p className="text-slate-500 font-bold text-sm">
              ...
              <Link to="/login" className="text-orange-600 hover:text-orange-700 font-black transition-colors">
                Log in here
              </Link>
            </p>
          </div>
